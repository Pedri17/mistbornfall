...
func physics_update(_delta: float) -> void:
	...
	if FALL and input.left_joystick.get_horizontal_sign() != ledge_direction:
		...
		return
	elif JUMP and direction_controller.direction == ledge_direction and JUMP.try_enter():
		return
