...
@export var wall_jump_velocity: Vector2 = Vector2(-100, -250)
@export var wall_jump_max_height: float = -300
...
func enter(previous_state_path: String, data := {}) -> void:
	...
	# Limit velocity added at a maximum.
	character.velocity.y = clamp(character.velocity.y + wall_jump_velocity.y, wall_jump_max_height, -wall_jump_max_height)
